...
<style>
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .cp-back:hover{transform:translateX(-3px);border-color:rgba(255,255,255,.2);background:rgba(255,255,255,.06);}
    .cp-back:active{transform:scale(.93);}
    .cp-back i{font-size:18px;}
    ...
    .cp-logo i{font-size:20px;color:var(--text);}

    .cp-info{flex:1;min-width:0;}
    .cp-title{font-size:24px;font-weight:800;letter-spacing:-.4px;color:var(--text);line-height:1.2;}
    .cp-sub{font-size:12px;color:var(--muted);font-weight:600;margin-top:4px;display:flex;align-items:center;gap:8px;}
    .cp-dot{width:6px;height:6px;border-radius:50%;background:#4cd982;animation:pdot 2s infinite;flex-shrink:0;}
    ...
    /* ===== BUTTONS ===== */
    .cp-acts{display:flex;gap:12px;padding-top:26px;margin-top:8px;border-top:1px solid rgba(255,255,255,.06);}
    .btn-s{
    ...
    /* <= 1100px: одна колонка, превью сверху */
    ...
    @media(max-width:992px){
        .cp{padding:32px 24px 80px;}
        .cp-card{padding:26px;}
        .cp-title{font-size:22px;}
        .cp-logo{width:48px;height:48px;}
        .cp-back{width:42px;height:42px;}
    }

    /* <= 768px: планшет */
    @media(max-width:768px){
        .cp{padding:24px 18px 70px;}
        .cp-top{margin-bottom:24px;gap:12px;}
        .cp-title{font-size:20px;}
        .cp-sub{font-size:11px;}
        .cp-logo{width:44px;height:44px;border-radius:13px;}
        .cp-logo i{font-size:17px;}
        .cp-back{width:40px;height:40px;border-radius:11px;}
        .cp-back i{font-size:16px;}

        .cp-card{padding:22px;border-radius:16px;}
        ...
        .cp-acts{flex-direction:column;gap:10px;padding-top:22px;}
    ...
    @media(max-width:576px){
        .cp{padding:18px 14px 60px;}
        .cp-top{margin-bottom:20px;gap:10px;}
        .cp-title{font-size:18px;}
        .cp-sub{font-size:10px;gap:6px;}
        .cp-dot{width:5px;height:5px;}
        .cp-logo{width:40px;height:40px;border-radius:11px;}
        .cp-logo i{font-size:15px;}
        .cp-back{width:38px;height:38px;border-radius:10px;}
        .cp-back i{font-size:15px;}

        .cp-card{padding:18px;border-radius:14px;}
        ...
        .cp-acts{padding-top:18px;gap:9px;}
    ...
    @media(max-width:480px){
        .cp{padding:14px 10px 50px;}
        .cp-top{margin-bottom:16px;gap:9px;}
        .cp-title{font-size:16px;}
        .cp-sub{font-size:9px;gap:5px;margin-top:3px;}
        .cp-dot{width:5px;height:5px;}
        .cp-logo{width:36px;height:36px;border-radius:10px;}
        .cp-logo i{font-size:14px;}
        .cp-back{width:34px;height:34px;border-radius:9px;}
        .cp-back i{font-size:14px;}

        .cp-card{padding:15px;border-radius:12px;}
        ...
        .cp-acts{padding-top:16px;gap:8px;}
    ...
    /* <= 400px: маленький телефон */
    @media(max-width:400px){
        .cp{padding:12px 8px 44px;}
        .cp-top{margin-bottom:14px;gap:8px;}
        .cp-title{font-size:15px;}
        .cp-sub{font-size:9px;}
        .cp-logo{width:33px;height:33px;border-radius:9px;}
        .cp-logo i{font-size:13px;}
        .cp-back{width:32px;height:32px;border-radius:8px;}
        .cp-back i{font-size:13px;}

        .cp-card{padding:13px;border-radius:11px;}
        ...
        .cp-acts{padding-top:14px;gap:7px;}
    ...
    @media(max-width:360px){
        .cp{padding:10px 6px 40px;}
        .cp-top{margin-bottom:12px;gap:7px;}
        .cp-title{font-size:14px;}
        .cp-sub{font-size:8px;}
        .cp-logo{width:30px;height:30px;border-radius:8px;}
        .cp-logo i{font-size:12px;}
        .cp-back{width:30px;height:30px;border-radius:8px;}
        .cp-back i{font-size:12px;}

        .cp-card{padding:11px;border-radius:10px;}
        ...
        .cp-acts{padding-top:12px;gap:6px;}
    ...
    @media(max-width:320px){
        .cp{padding:8px 5px 36px;}
        .cp-top{margin-bottom:10px;gap:6px;}
        .cp-title{font-size:13px;}
        .cp-sub{font-size:8px;}
        .cp-logo{width:28px;height:28px;border-radius:7px;}
        .cp-logo i{font-size:11px;}
        .cp-back{width:28px;height:28px;border-radius:7px;}
        .cp-back i{font-size:11px;}

        .cp-card{padding:10px;border-radius:9px;}
...
<div class="cp">
    ...
    <div class="cp-top">
        <a href="{{ route('departments.index') }}" class="cp-back" aria-label="Back"><i class="bi bi-arrow-left"></i></a>
        <div class="cp-logo"><i class="bi bi-plus-lg"></i></div>
        <div class="cp-info">
            <h1 class="cp-title" data-i18n="title">Создать отдел</h1>
            <div class="cp-sub">
                <span class="cp-dot"></span>
                <span data-i18n="subtitle">Заполните данные для нового подразделения</span>
            </div>
        </div>
    </div>
    ...
    <div class="cp-grid">
        ...
        <div class="cp-card">
            <form action="{{ route('departments.store') }}" method="POST">
                ...
                <div class="fg">
                    ...
                    <div class="lv-w" id="levelSelectWrap">
                        <div class="lv-cur" id="levelCurrent">
                            <div class="lv-n" id="lcNum">{{ old('level', 1) }}</div>
                            <div class="lv-i">
                                <div class="lv-nm" id="lcName">—</div>
                                <div class="lv-sb" id="lcSub">L{{ old('level', 1) }}</div>
                            </div>
                        ...
                        <input type="hidden" name="level" id="levelInput" value="{{ old('level', 1) }}">
                    </div>
                ...
                <div class="fg">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="fi" data-i18n-placeholder="namePlaceholder" placeholder="Например: IT-Дивизион" maxlength="255" required>
                ...
                <div class="fg" id="parentGroup">
                    ...
                    <select id="parent_id" name="parent_id" class="fs">
                        ...
                        $optLevel = (int)($m[1] ?? 0);
                        @endphp
                        <option value="{{ $id }}" data-level="{{ $optLevel }}" {{ old('parent_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="fg-row">
                    <div class="fg">
                        ...
                        <div class="icon-w">
                            <div class="icon-pv" id="iconPreview">{{ old('icon', '—') }}</div>
                            <input type="text" id="icon" name="icon" value="{{ old('icon', '') }}" class="fi" maxlength="4" data-i18n-placeholder="iconPlaceholder" placeholder="Символ">
                        </div>
                    </div>
                    <div class="fg">
                        ...
                        <div class="clr-w">
                            <div class="clr-sw">
                                <input type="color" id="color" name="color" value="{{ old('color', $levelColors[old('level', 1)] ?? '#4f8cff') }}">
                            </div>
                            <input type="text" class="clr-hex" id="colorHex" value="{{ old('color', $levelColors[old('level', 1)] ?? '#4f8cff') }}" maxlength="7" readonly>
                ...
                <div class="fg">
                    ...
                    <textarea id="description" name="description" rows="3" class="ft" data-i18n-placeholder="descPlaceholder" placeholder="Краткое описание отдела..." maxlength="1000">{{ old('description') }}</textarea>
                </div>

                <div class="cp-acts">
                    <button type="submit" class="btn-s">
                        <i class="bi bi-check-lg"></i>
                        <span data-i18n="submitBtn">Создать отдел</span>
                    </button>
                    <a href="{{ route('departments.index') }}" class="btn-c">
        ...
        <div class="pv-w">
            <div class="pv-card">
                ...
                <div class="pv-vis" id="pvVisual">
                    <div class="pv-top">
                        <div class="pv-ic" id="pvIcon">—</div>
                        <div class="pv-tt">
                            <span class="pv-chip" id="pvLevel"><i class="bi bi-layers-fill"></i> L1</span>
                            <h3 class="pv-nm" id="pvName" data-i18n="pvNameDefault">Название отдела</h3>
                        </div>
                    </div>
                    <p class="pv-ds" id="pvDesc" data-i18n="pvDescDefault">Краткое описание...</p>
                </div>
                <div class="pv-mt">
                    <span class="pv-mi">
                        <i class="bi bi-people-fill"></i>
                        <span><strong>0</strong> <span data-i18n="members">участников</span></span>
                    </span>
                    <span class="pv-mi" id="pvParentMeta" style="display:none">
                        <i class="bi bi-arrow-up-right"></i>
                        <span id="pvParentText">—</span>
                    </span>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    const T={
        ru:{title:'Создать отдел',subtitle:'Заполните данные для нового подразделения',levelLabel:'Уровень иерархии',nameLabel:'Название',namePlaceholder:'Например: IT-Дивизион',parentLabel:'Родительский отдел',parentEmpty:'— Верхний уровень (без родителя) —',parentHint1:'Для уровня 1 родитель не нужен',parentHint2:'Выберите отдел уровня',iconLabel:'Иконка',iconPlaceholder:'Символ',colorLabel:'Цвет',colorAuto:'Авто',descLabel:'Описание',descPlaceholder:'Краткое описание отдела...',submitBtn:'Создать отдел',cancelBtn:'Отмена',previewTitle:'Предпросмотр',pvNameDefault:'Название отдела',pvDescDefault:'Краткое описание...',members:'участников'},
        tj:{title:'Эҷод кардани шӯъба',subtitle:'Маълумотро барои зерсохтори нав пур кунед',levelLabel:'Сатҳи иерархия',nameLabel:'Ном',namePlaceholder:'Масалан: IT-Дивизион',parentLabel:'Шӯъбаи волидайн',parentEmpty:'— Сатҳи болоӣ (бе волидайн) —',parentHint1:'Барои сатҳи 1 волидайн лозим нест',parentHint2:'Шӯъбаи сатҳро интихоб кунед',iconLabel:'Нишона',iconPlaceholder:'Аломат',colorLabel:'Ранг',colorAuto:'Авто',descLabel:'Тавсиф',descPlaceholder:'Тавсифи мухтасари шӯъба...',submitBtn:'Эҷод кардан',cancelBtn:'Бекор',previewTitle:'Пешнамоиш',pvNameDefault:'Номи шӯъба',pvDescDefault:'Тавсифи мухтасар...',members:'иштирокчиён'},
        en:{title:'Create Department',subtitle:'Fill in data for new subdivision',levelLabel:'Hierarchy Level',nameLabel:'Name',namePlaceholder:'e.g. IT Division',parentLabel:'Parent Department',parentEmpty:'— Top level (no parent) —',parentHint1:'Level 1 does not need a parent',parentHint2:'Select department of level',iconLabel:'Icon',iconPlaceholder:'Symbol',colorLabel:'Color',colorAuto:'Auto',descLabel:'Description',descPlaceholder:'Short department description...',submitBtn:'Create',cancelBtn:'Cancel',previewTitle:'Preview',pvNameDefault:'Department name',pvDescDefault:'Short description...',members:'members'}
    };
    ...
    function preview(){
        ...
        pvName.textContent=nameInput.value.trim()||d().pvNameDefault;
        pvDesc.textContent=descInput.value.trim()||d().pvDescDefault;
